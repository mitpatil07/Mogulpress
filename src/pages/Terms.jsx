  ...
  return (
    <div className="bg-white font-sans leading-relaxed text-gray-700">
      ...
      <header className="bg-black text-white text-center py-20 px-4">
        <h1 className="text-yellow-500 text-lg font-semibold">Magnates Press</h1>
        <h2 className="text-5xl font-bold mt-2">Terms & Conditions</h2>
        <p className="mt-4 max-w-2xl mx-auto">
          These terms and conditions outline the rules and regulations for the use of Magnates Press Global LLC's Website.
        </p>
      </header>
      ...
      <main className="max-w-6xl mx-auto p-8 bg-white  my-12 rounded-lg">
        ...
        <section>
          <SectionTitle>Welcome to Magnates Press</SectionTitle>
          <p className="mb-4">These terms and conditions outline the rules and regulations for the use of Magnates Press Global LLC's Website.</p>
          <p className="mb-4">By accessing this website we assume you accept these terms and conditions. Do not continue to use Magnates Press website if you do not agree to take all of the terms and conditions stated on this page.</p>
        ...
        <section>
            ...
            <p className="mb-4">We employ the use of cookies. By accessing Magnates Press website, you agreed to use cookies in agreement with the Magnates Press Global LLC's Privacy Policy.</p>
            <p>Most interactive websites use cookies to let us retrieve the user’s details for each visit. Cookies are used by our website to enable the functionality of certain areas to make it easier for people visiting our website. Some of our affiliate/advertising partners may also use cookies.</p>
        </section>

        <section>
            <SectionTitle>License</SectionTitle>
            <p className="mb-4">Unless otherwise stated, Magnates Press Global LLC and/or its licensors own the intellectual property rights for all material. All intellectual property rights are reserved. You may access this for your own personal use subjected to restrictions set in these terms and conditions.</p>
            <p className="mb-2 font-semibold">You must not:</p>
            <ul className="space-y-2 mb-4">
                <ListItem>Republish material from Magnates Press</ListItem>
                <ListItem>Sell, rent or sub-license material from Magnates Press</ListItem>
                <ListItem>Reproduce, duplicate or copy material from Magnates Press</ListItem>
                <ListItem>Redistribute content from Magnates Press</ListItem>
            </ul>
            <p className="mb-4">This Agreement shall begin on the date hereof.</p>
            <p className="mb-4">Parts of this website offer an opportunity for users to post and exchange opinions and information in certain areas of the website. Magnates Press Global LLC does not filter, edit, publish or review Comments prior to their presence on the website. Comments do not reflect the views and opinions of Magnates Press Global LLC, its agents and/or affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To the extent permitted by applicable laws, Magnates Press Global LLC shall not be liable for the Comments or for any liability, damages or expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.</p>
            <p className="mb-4">Magnates Press Global LLC reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate, offensive or causes a breach of these Terms and Conditions.</p>
            ...
            <p>You hereby grant Magnates Press Global LLC a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.</p>
        </section>
        ...
        <section>
            ...
            <p className="mb-4">We will approve link requests from these organizations if we decide that: (a) the link would not make us look unfavorably to ourselves or to our accredited businesses; (b) the organization does not have any negative records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of Magnates Press Global LLC; and (d) the link is in the context of general resource information.</p>
            ...
            <p className="mb-4">If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you must inform us by sending an email to Magnates Press Global LLC. Please include your name, your organization name, contact information as well as the URL of your site, a list of any URLs from which you intend to link to our Website, and a list of the URLs on our site to which you would like to link. Wait 2-3 weeks for a response.</p>
            ...
            <p>No use of Magnates Press Global LLC's logo or other artwork will be allowed for linking absent a trademark license agreement.</p>
        </section>
        ...
        <section>
            ...
            <p>It is totally forbidden to duplicate, reproduce, or distribute any content from Magnates Press without authorization. This covers any content that is shown on the website, including text, pictures, videos, and other files. Under international treaties and copyright regulations, every content on Magnates Press is protected. Any action that includes the unapproved duplication of content by users is strictly forbidden without express written consent from Magnates Press. If this policy is broken, user accounts may be suspended or terminated, legal action may be taken, and Magnates Press may take other appropriate measures as well.</p>
        </section>
