...
const StatCard = ({ icon, number, label }) => (
  <div className="flex flex-col items-center text-center">
    <div className="text-5xl text-[#dcb25c] mb-4">{icon}</div>
    <p className="text-4xl md:text-5xl font-extrabold text-gray-900" style={{ fontFamily: "'Montserrat', sans-serif" }}>{number}</p>
...
const App = () => {
  ...
  return (
    // Note: To match the fonts, add this to your public/index.html head tag:
    ...
    <div className="bg-white text-gray-800" style={{ fontFamily: "'Poppins', sans-serif" }}>
      ...
      <section className="bg-[#f7f7f7] py-18">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center">
            <p className="text-[#dcb25c] text-xl tracking-widest mb-4">TELL US HOW WE CAN HELP</p>
            <h2 className="text-4xl md:text-5xl font-extrabold text-gray-900" style={{ fontFamily: "'Montserrat', sans-serif" }}>
              Unlock Your Media <span className="text-[#dcb25c]"><br/>Potential with Us</span>
            </h2>
            <p className="mt-6 text-black-500 text-xl max-w-6xl mx-auto">
          ...
          <form className="mt-12 space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <input type="text" placeholder="Your Name" className="w-full p-4 bg-white border border-gray-300 rounded-md focus:ring-[#dcb25c] focus:border-[#dcb25c] transition" />
              <input type="email" placeholder="Your Email" className="w-full p-4 bg-white border border-gray-300 rounded-md focus:ring-[#dcb25c] focus:border-[#dcb25c] transition" />
              <select className="w-full p-4 bg-white border border-gray-300 rounded-md text-gray-500 focus:ring-[#dcb25c] focus:border-[#dcb25c] transition">
                <option>Which service are you interested in</option>
              </select>
              <select className="w-full p-4 bg-white border border-gray-300 rounded-md text-gray-500 focus:ring-[#dcb25c] focus:border-[#dcb25c] transition">
                <option>What's Your Estimated Budget</option>
              </select>
              <input type="tel" placeholder="Your Phone (Optional)" className="w-full p-4 bg-white border border-gray-300 rounded-md focus:ring-[#dcb25c] focus:border-[#dcb25c] transition" />
              <input type="text" placeholder="Your Company/Organization (Optional)" className="w-full p-4 bg-white border border-gray-300 rounded-md focus:ring-[#dcb25c] focus:border-[#dcb25c] transition" />
            </div>
            <textarea placeholder="Let us know a bit about your project" rows="6" className="w-full p-4 bg-white border border-gray-300 rounded-md focus:ring-[#dcb25c] focus:border-[#dcb25c] transition"></textarea>
            ...
            <div className="text-center pt-4">
              <button type="submit" className="bg-[#dcb25c] text-black font-bold py-4 px-12 rounded-md hover:bg-[#c8a04a] transition-colors text-lg shadow-lg">
      ...
      {/* Section 4: Book A Call (Calendly) */}
      <section className="bg-black text-white py-20">
        <div className="container mx-auto px-4 text-center">
            <p className="text-[#dcb25c] font-bold tracking-widest mb-4">CONTACT US</p>
            <h2 className="text-4xl md:text-5xl font-extrabold" style={{ fontFamily: "'Montserrat', sans-serif" }}>
                Book A Call Below
            </h2>
            <div className="mt-12 max-w-3xl mx-auto bg-white p-12 text-gray-800 rounded-lg relative overflow-hidden shadow-2xl">
                <div className="absolute top-0 right-0 h-16 w-16">
                  <div className="absolute transform rotate-45 bg-gray-600 text-center text-white font-semibold py-1 right-[-34px] top-[32px] w-[170px] text-sm">
                      Powered by Calendly
                  </div>
                </div>
                <h3 className="text-xl font-bold mb-4">This Calendly URL is not valid.</h3>
                <p className="text-gray-500">If you are the owner of this account, you can <a href="#" className="text-blue-600 hover:underline">log in</a> to find out more.</p>
            </div>
        </div>
      </section>
          ...
          <div className="container mx-auto px-4 text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-16 mt-16 max-w-5xl mx-auto">
                    <ConnectCard icon={<FiMail />} title="Email Us">
                        <a href="mailto:info@mogulpress.com" className="text-gray-500 hover:text-[#dcb25c] transition-colors">info@mogulpress.com</a>
                    </ConnectCard>
      ...
      <button onClick={scrollToTop} aria-label="Scroll to top" className="fixed bottom-5 right-5 bg-[#dcb25c] text-black h-12 w-12 rounded-md flex items-center justify-center shadow-lg hover:bg-[#c8a04a] transition-colors z-50">
        <FiArrowUp />
      </button>
    </div>
  );
